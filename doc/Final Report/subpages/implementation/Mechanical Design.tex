...
\begin{figure}[H]
    \begin{minipage}[h]{0.95\textwidth}
        \centering
        \includegraphics[height=8cm]{imgs/freecad/belttensioner.jpg}
...
\todo{show nema17 mount and endstop}
\todo{show belt driven arm design, inspired by 3D printer designs}
\todo{show off gantry, ender 3 design inspiration with v rollers}
\todo{show belt tensioner design}
\todo{show adjustable arm height design}
\todo{show bin design}