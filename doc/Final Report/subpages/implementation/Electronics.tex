...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.45\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=5cm, keepaspectratio]{example-image-b}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.45\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=5cm, keepaspectratio]{example-image-c}
    \end{minipage}
    \caption{PCB for NEMA17 Stepper Motor Control}
\end{figure}
\todo{include diagram and picture of motor driver}
