...
\begin{table}[H]
    ...
    \begin{tabularx}{0.8\textwidth}{|p{3cm}|X|}
        ...
        \hline
        \texttt{RPi Dataset Builder} & Opens the dataset collection tool, capturing images from the VNC window connected to the Pi \\
        \hline
        \texttt{Open Dataset Sorter} & Opens the dataset sorter tool that sorts a local dataset and reads the labels if they exist \\
        \hline
        \texttt{Open Resistor Band Annotation} & Opens the resistor band annotation tool \\
        \hline
    \end{tabularx}
...
\begin{table}[H]
    ...
    \begin{tabularx}{0.8\textwidth}{|p{3cm}|X|}
        ...
        \hline
        \texttt{Mouse Left Click} & Draw line for OBB \\
        \hline
        \texttt{Mouse Middle Click} & Cancel OBB \\
        \hline
    \end{tabularx}
...
\begin{minipage}[H]{\textwidth}
    \centering
    \begin{minted}[linenos, fontsize=\footnotesize, breaklines]{python}
    try:
